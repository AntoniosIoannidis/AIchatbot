  ...
  return (
    <main className="chat-stage">
      ...
      <div className="brand-header">
        <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-indigo-500 to-purple-600 flex items-center justify-center shadow-2xl shadow-indigo-500/40 border border-white/10 mb-2">
      ...
      <div className="input-dock">
        ...
        <form onSubmit={handleSendMessage} className="input-pill">
          ...
          <button 
            ...
            className="flex-shrink-0 flex items-center justify-center w-10 h-10 rounded-full text-slate-400 hover:text-white hover:bg-white/5 transition-all"
            title="Upload Image"
          >
            <ImageIcon size={20} />
          </button>
